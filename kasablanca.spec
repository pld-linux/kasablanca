...
Kasablanca to graficzny klient FTP dla KDE. Obsługuje między innymi
szyfrowanie SSL/TLS (zarówno polecenia, jak i dane przy użyciu
uwierzytelnionego TLS, nie sftp), fxp (bezpośrednie przesyłanie danych
z FTP do FTP), zakładki i zapytania.
